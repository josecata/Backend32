...
exports.routerCart
    ...
    return __generator(this, function (_a) {
        ...
        cart.deleteCartById(id).then(function (result) { return (result ? res.status(202).json('Carrito eliminado') : res.status(404).json('No se encontró el carrito')); });
        return [2 /*return*/];
    });
}); })
...
exports.routerCart
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                products_2 = _a.sent();
                products_2 ? res.status(200).json(products_2) : res.status(404).json({ error: 'No se encontró el carrito solicitado' });
                return [3 /*break*/, 3];
            case 2:
